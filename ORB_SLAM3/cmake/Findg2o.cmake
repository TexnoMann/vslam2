FIND_PATH(g2o_INCLUDE_DIR
        NAMES g2o/config.h
        HINTS $ENV{CATKIN_WS}/devel/include)
...
if (g2o_INCLUDE_DIR)
    ...
    if (g2o_LIBRARY)
        ...
        set(g2o_LIBRARY $ENV{CATKIN_WS}/devel/lib/libg2o.so)
        message("CMake Modules g2o LIB not found | bdc HARDCODING")
        message("CMake Modules g2o LIB:  ${g2o_LIBRARY}")
    endif ()
else ()
    message("CMake Modules g2o not found | bdc HARDCODING")
    set(g2o_INCLUDE_DIR $ENV{CATKIN_WS}/devel/include/g2o)
    set(g2o_LIBRARY $ENV{CATKIN_WS}/devel/lib/g2o/libg2o.so)
